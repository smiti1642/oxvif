...
| Doc | About |
|-----|-------|
| [`service-capabilities-and-ptz-tours.md`](active/service-capabilities-and-ptz-tours.md) | Target 0.15.0. Finish the services oxvif already owns: `GetServiceCapabilities` on all nine (currently implemented on **zero**), PTZ preset tours, PTZ-level `SendAuxiliaryCommand`. 17 operations. Stage 0 is WSDL transcription — the reference docs do not yet carry field detail for the types involved. Not started. |
