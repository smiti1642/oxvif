...
| [`mock-fidelity-operation-ledger.md`](active/mock-fidelity-operation-ledger.md) · [繁體中文](active/mock-fidelity-operation-ledger_zh.md) | Complete route-arm inventory at `b134f73`, with handler/argument locations and separate audit statuses; maintained with a read-only drift checker, not a conformance claim. |
