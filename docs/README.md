...
| Doc | About |
|-----|-------|
| [`mock-fidelity-hardening-plan.md`](active/mock-fidelity-hardening-plan.md) · [繁體中文](active/mock-fidelity-hardening-plan_zh.md) | Approved hardening programme with selected request, Fault, effect-policy and external-corpus slices implemented; broader service semantics remain partial. Current acceptance is owned by the release cut. |
| [`mock-fidelity-execution-checklist.md`](active/mock-fidelity-execution-checklist.md) · [繁體中文](active/mock-fidelity-execution-checklist_zh.md) | Source-indexed work packages, dependencies, per-operation readiness cards, risk register and acceptance/handoff requirements; execution layer of the hardening plan. |
| [`mock-fidelity-operation-ledger.md`](active/mock-fidelity-operation-ledger.md) · [繁體中文](active/mock-fidelity-operation-ledger_zh.md) | Route-arm inventory begun at `b134f73` and maintained against the candidate, with handler/argument locations and separate audit statuses; a read-only drift checker does not establish conformance. |
| [`mock-fidelity-source-audit.md`](active/mock-fidelity-source-audit.md) · [繁體中文](active/mock-fidelity-source-audit_zh.md) | Measured full Action/method correspondence, reader-call multiset, migration ownership and K12–K16 findings; checked against source. |
| [`mock-fidelity-profile-preflight.md`](active/mock-fidelity-profile-preflight.md) · [繁體中文](active/mock-fidelity-profile-preflight_zh.md) | First 13 Media profile/binding operation cards, transitive paths, reproduced gaps and explicit remaining readiness requirements. |
| [`mock-fidelity-pipeline-preflight.md`](active/mock-fidelity-pipeline-preflight.md) · [繁體中文](active/mock-fidelity-pipeline-preflight_zh.md) | Request-chain dependencies, raw responder compatibility, profile decode/render coupling, K17 replay invalidation and ordered implementation sub-slices. |
