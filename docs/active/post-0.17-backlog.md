...
| F05 | Implementation: W07–W09; [pipeline](mock-fidelity-pipeline-preflight.md) | Notification connection/deadline/framing limits are delivered below. Remaining work is broader mock HTTP binding, roles and fault injection (AF1 freshness/replay is delivered); do not reimplement delivered scoped auth. |
...
| F07 | Implementation/evidence: W20–W23; [schema preflight](mock-fidelity-schema-preflight.md) | RS1/EP1/OS1/EP2/AF1 expanded the selected corpus to 224 instances/60 operations, independently validated locally. Expand remaining coverage while preserving explicit anchors, pinned external resources, negative controls and bounded fuzz/property seeds. The 0.17 selected CI gate is separate historical evidence. |
...
| F05 | Broader HTTP binding, roles and fault injection redesign; AF1 freshness/replay delivered | W07–W09; only after current-release security/integrity triage; raw hooks remain explicit escape hatches |
