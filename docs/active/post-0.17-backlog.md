...
| F07 | Implementation/evidence: W20–W23; [schema preflight](mock-fidelity-schema-preflight.md) | RS1/EP1/OS1 expanded the selected corpus to 198 instances/56 operations, independently validated locally. Expand remaining coverage while preserving explicit anchors, pinned external resources, negative controls and bounded fuzz/property seeds. The 0.17 selected CI gate is separate historical evidence. |
