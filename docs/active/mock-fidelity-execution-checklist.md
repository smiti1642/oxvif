...
| K28 / URL credentials in keys fixed | Canonical projections and legacy loaded/caller keys strip URL credential pairs; load is read-only and explicit save persists cleanup | W19 partial; synthetic privacy/lookup/disk controls, unchanged JSON shape; raw-envelope redaction remains targeted and K27 collisions remain open; see pipeline preflight |
