...
| W19 / M3,M6 / PARTIAL | W03/W09 designs | Built-in CreateProfile/DeleteProfile use private committed effects; selected cross-service reads, HTTP, instance and chain controls added | Bindings and other mutations, standalone replay policy, full read dependencies, normalization/key collisions and concurrent/callback visibility remain open; no new recording of device secrets |
