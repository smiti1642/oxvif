...
| W18 / M4 / PARTIAL | W10–W16 candidate behavior | K13 collision-safe allocation; K16 atomic binding plans; conditional notifications; K08 hooks receive commit snapshots outside the state lock | Selected allocation, binding and reentrant/snapshot controls; broader concurrent writes, instances, rollback, queue/read snapshots and replay remain open; public signatures unchanged, callback ordering caller-managed |
