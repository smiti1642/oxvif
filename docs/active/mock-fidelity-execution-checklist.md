...
| W22 / M5 / TODO | W00 checker, W21 | `.github/workflows/ci.yml`, proposed dedicated schema job and release evidence check | Run inventory checker automatically; schema job fails on missing tools/files, digest/download/import errors; least privilege, no schema/secret artifacts; missing/skipped required job blocks release acceptance |
