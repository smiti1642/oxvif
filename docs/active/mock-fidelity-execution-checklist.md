...
| W21 / M5 / PARTIAL | W20, D3 | External validator selection experiment completed for SOAP/Media; K19 records XSD 1.0 rejection versus XSD 1.1 compilation | Complete pinned source closure, offline resolver, verification scripts and positive/negative instance qualification; schema compilation alone is not acceptance |
| W22 / M5 / PARTIAL | W00 for inventory; W21 for schema job | Windows/Linux inventory passed hosted run 34454688822 at e8fda59; package depends on it. Dedicated schema job and release evidence check still pending | Inventory/self-tests must pass; schema job fails on missing tools/files, digest/download/import errors; least privilege, no schema/secret artifacts; missing/skipped required job blocks release acceptance |
