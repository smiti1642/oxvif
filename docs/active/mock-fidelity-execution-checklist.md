...
| W21 / M5 / PARTIAL | W20, D3 | 23-file catalogue, pinned Python/Xerces dependencies, offline tooling, 18 schema-free controls and five explicit independent-backend qualification tests | Xerces compiles all 12 roots without warnings; Python's K21 remains diagnosed, not suppressed. Mock corpus/export and full SOAP/payload/Fault qualification still required |
