...
| W18 / M4 / PARTIAL | W10–W16 candidate behavior | Conditional notification fixes K14 DeleteProfile refusals; public state-helper semantics preserved | Concurrent writes, independent instances, complete rollback, other operation hooks, reentrancy/lock behavior and replay remain open; conditional notification is not transaction rollback |
