...
| W18 / M4 / PARTIAL | W10–W16 candidate behavior | K13 allocation is serialized and collision-safe; conditional notification covers duplicate creation and K14 DeleteProfile refusals; public state-helper semantics preserved | Selected allocation concurrency is tested; broader concurrent writes, independent instances, complete rollback, other operation hooks, reentrancy/lock behavior and replay remain open |
