...
| W10 | 已遷移 OS1 scoped OSD candidate、selector、color／position、TextString | 共用 renderer／client XML 修正、來源配額及 commit effect；未建模 extension 明確拒絕 |
