...
| `media.DeleteProfile` | `media::handle_delete_profile` | `state, body` | W10 | PARTIAL | PARTIAL | PARTIAL | PARTIAL | PARTIAL | E1,P1 |
...
| `media2.DeleteProfile` | `media2::handle_delete_profile_media2` | `state, body` | W10 | PARTIAL | PARTIAL | PARTIAL | PARTIAL | PARTIAL | E1,P1 |
