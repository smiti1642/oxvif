...
- **ONVIF Profile:** T
- **oxvif status:** ◐ partially implemented in `src/client/media2.rs`; see the operation table below.
...
| SetSynchronizationPoint | profile-associated stream synchronization | ✓ | `set_synchronization_point_media2` |
