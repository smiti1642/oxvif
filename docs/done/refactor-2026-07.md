...
**Archived 2026-09-22 — completed delivery.** Stages 0–4, including the 64/64 scoped coverage repairs, shipped in 0.14. This ledger preserves the original baseline, not current coverage.
...
[`docs/done/stage4-ledger.md`](stage4-ledger.md)** — 148 rows with per-method
