...
**Archived 2026-09-22 — this bounded delivery shipped in 0.17.0.**
Closure evidence: [final verification and publication record](release-0.17-finalization.md). The versions, permissions, pending gates and test limits below retain their dated batch context; they are not current publication status. Archival adds no hardware, native-terminal or VMS verification. Broader unfinished work remains in the [post-release backlog](../active/post-0.17-backlog.md) and active parent plans.
...
candidate acceptance is tracked in the [execution checklist](../active/mock-fidelity-execution-checklist.md).
...
Extends the 13 source-operation cards in [profile preflight](../active/mock-fidelity-profile-preflight.md).
