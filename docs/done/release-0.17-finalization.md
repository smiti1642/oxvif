...
[Fleet acceptance](../active/mock-fleet-basic-plan.md#local-evidence), the
[baseline review](release-0.17-review.md) and [follow-up backlog](../active/post-0.17-backlog.md).
