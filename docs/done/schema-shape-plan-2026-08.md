...
**Archived 2026-09-22 — completed delivery.** The bounded audit, PTZ wiring and schema-shape sweep shipped in 0.15; see [the completed schema sweep](mock-schema-conformance-2026-08.md) and [audit](mock-audit-2026-07.md). Broader fidelity and schema coverage remain active.
The original dated evidence and limitations below are retained; earlier planning status is historical.
...
**Why** — `docs/done/mock-audit-2026-07.md` closed four tiers of *state*
...
attributes to seventeen. See `docs/done/mock-schema-conformance-2026-08.md`
§1.3 and §5.6.
