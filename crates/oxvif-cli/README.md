...
Read the [release summary](https://github.com/smiti1642/oxvif/blob/b6c87ee95fddf32cd10cfe8c817be57ec401fca7/docs/releases/0.17.0.md)
and [full changes, migration and limitations](https://github.com/smiti1642/oxvif/blob/b6c87ee95fddf32cd10cfe8c817be57ec401fca7/docs/releases/0.17.0-changelog.md).
...
[CLI guide](https://github.com/smiti1642/oxvif/blob/b6c87ee95fddf32cd10cfe8c817be57ec401fca7/docs/oxvif-cli.md).
...
[maintenance guide](https://github.com/smiti1642/oxvif/blob/b6c87ee95fddf32cd10cfe8c817be57ec401fca7/docs/cli-maintenance.md)
...
Press `a` in manage discovery to explicitly save a camera; inline setup supports
retry and consecutive additions. Saved-device search, per-camera state across
switching, retained error reports, report search and editable path drafts are
documented in the maintenance guide above.
...
status bar separate from key hints; see the [navigation guide](https://github.com/smiti1642/oxvif/blob/b6c87ee95fddf32cd10cfe8c817be57ec401fca7/docs/cli-maintenance.md#vim-style-navigation).
...
[full CLI manual](https://github.com/smiti1642/oxvif/blob/b6c87ee95fddf32cd10cfe8c817be57ec401fca7/docs/oxvif-cli.md#device-inventory).
...
See the [CLI guide](https://github.com/smiti1642/oxvif/blob/b6c87ee95fddf32cd10cfe8c817be57ec401fca7/docs/oxvif-cli.md)
for the supported command surface, and the
[0.17 migration and limitations](https://github.com/smiti1642/oxvif/blob/b6c87ee95fddf32cd10cfe8c817be57ec401fca7/docs/releases/0.17.0-changelog.md)
