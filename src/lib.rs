...
pub use types::{
    ...
    PullPointSubscription, RecordingInformation, RecordingItem, RecordingJob,
    RecordingJobConfiguration, RecordingJobState, RecordingSourceInformation, RecordingTrack,
    RelayOutput, Resolution, SecurityCapabilities, SnapshotUri, SourceBounds, StorageConfiguration,
