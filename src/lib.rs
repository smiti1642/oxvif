...
pub use types::{
    ...
    Hostname, ImagingOptions, ImagingSettings, IntRange, IoCapabilities, JpegOptions,
    MediaCapabilities, MediaProfile, MediaProfile2, NetworkCapabilities, NotificationMessage,
    NtpInfo, OnvifService, PtzConfiguration, PtzConfigurationOptions, PtzNode, PtzPreset,
