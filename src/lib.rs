...
//! [migration guide](https://github.com/smiti1642/oxvif/blob/ddec9ecfc69d503c54c487c28feb64fdad32dca5/docs/media2-frame-rate.md).
...
//! [audio/metadata guide](https://github.com/smiti1642/oxvif/blob/ddec9ecfc69d503c54c487c28feb64fdad32dca5/docs/audio-metadata.md).
...
//! Both push listeners bound active connections and request time, and reject
//! ambiguous HTTP framing; see [`notification_listener`] for the limits.
